...
#include <string.h>			// Header file for the c string library
...
void Model_3DS::MaterialNameChunkProcessor(long /*length*/, long findex, int matindex)
{
	...
	for (int i = 0; i < 80; i++)
	{
		...
		{
			Materials[matindex].name[i] = 0; // this does nothing, but I'll leave it there anyways...
			break;
		}
	}
...
void Model_3DS::MapNameChunkProcessor(long /*length*/, long findex, int /*matindex*/)
{
	...
	for (int i = 0; i < 80; i++)
	{
		...
		if (name[i] == 0)
		{
			name[i] = 0; // this does nothing, but I'll leave it there anyways...
			break;
		}
	}
...
void Model_3DS::ObjectChunkProcessor(long length, long findex, int objindex)
{
	...
	for (int i = 0; i < 80; i++)
	{
		...
		{
			Objects[objindex].name[i] = 0; // this does nothing, but I'll leave it there anyways...
			break;
		}
	}
